...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.section == 0 || indexPath.section == 1) {
        ...
        if (indexPath.section == 0) {
            [stateSwitch addTarget:self action:@selector(lockSwitchDidChange:) forControlEvents:UIControlEventValueChanged];
            ...
            [stateSwitch addTarget:self action:@selector(shakeSwitchDidChange:) forControlEvents:UIControlEventValueChanged];
